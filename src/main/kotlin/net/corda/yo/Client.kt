...
private class YoRPC {
    ...
    fun main(args: Array<String>) {
        ...
        // Grab all signed transactions and all future signed transactions. (NOTE: This is Deprecated)
        val (transactions, futureTransactions) = proxy.internalVerifiedTransactionsFeed()
        // val (transactions, futureTransactions) = proxy.networkMapFeed().updates // internalVerifiedTransactionsFeed()
